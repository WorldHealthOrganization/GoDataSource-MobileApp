...
class EventSingleInvestigationContainer extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        if (nextProps.isEditMode !== this.props.isEditMode || nextProps.routeKey === 'eventInvestigation') {
            return true;
        }
        return false;
    }
...
function mapStateToProps(state) {
    return {
        ...
        questions: get(state, 'outbreak.eventInvestigationTemplate', null),
        translation: get(state, 'app.translation', []),
        role: get(state, 'role', [])
    };
}

export default connect(mapStateToProps)(EventSingleInvestigationContainer);
