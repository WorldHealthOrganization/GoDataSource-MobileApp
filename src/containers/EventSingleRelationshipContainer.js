...
class EventSingleRelationshipContainer extends Component {
    ...
    getContactName = (relation) => {
        ...
        return {title: computeFullName(eventData), primaryText: moment.tz(relationshipData.contactDate, this.props.timezone).format("YYYY-MM-DD").toString(), secondaryText: getTranslation(relationshipData.certaintyLevelId, this.props.translation)};
    };
