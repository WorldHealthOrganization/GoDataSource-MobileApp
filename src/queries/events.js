...
export function getEventsForOutbreakIdRequest (outbreakId, token, callback) {
    ...
    database.allDocs({
        startkey: `person.json_LNG_REFERENCE_DATA_CATEGORY_PERSON_TYPE_EVENT_false_${outbreakId}_`,
        endkey: `person.json_LNG_REFERENCE_DATA_CATEGORY_PERSON_TYPE_EVENT_false_${outbreakId}_\uffff`,
        include_docs: true
    })
        .then((result) => {
