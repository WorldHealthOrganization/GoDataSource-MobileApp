...
const caseSingleScreen = {
    ...
    lastNameLabel: 'LNG_CASE_FIELD_LABEL_LAST_NAME',
    ...
    dateOfBirth: 'LNG_CASE_FIELD_LABEL_DOB',
...
const followUpsScreenStatusFilterValues = {
    ...
    missedValue: 'LNG_REFERENCE_DATA_CONTACT_DAILY_FOLLOW_UP_STATUS_TYPE_MISSED'
};
...
const generalButtons = {
    nextButtonLabel: 'LNG_COMMON_BUTTON_NEXT',
    backButtonLabel: 'LNG_COMMON_BUTTON_BACK',
...
const questionCardLabels = {
    textInputLabel: 'LNG_QUESTIONNAIRE_LABEL_WRITE_ANSWER',
...
const followUpStatuses = {
    ...
    notAttempted: 'LNG_REFERENCE_DATA_CONTACT_DAILY_FOLLOW_UP_STATUS_TYPE_NOT_ATTEMPTED',
...
const TextSwitchSelectorAgeOrDobValues = {
    ...
    dobLabel: 'LNG_CONTACT_FIELD_LABEL_DATE_OF_BIRTH',
};

const ageUnitOfMeasureDropDown = {
    yearsLabel: 'LNG_AGE_FIELD_LABEL_YEARS',
    monthsLabel: 'LNG_AGE_FIELD_LABEL_MONTHS',
};
